...
namespace CBS.BankMGT.MediatR.Handlers
{
    ...
    /// </summary>
    public class DeleteThirdPartyInstitutionommandHandler : IRequestHandler<DeleteThirdPartyInstitutionCommand, ServiceResponse<bool>>
    {
        private readonly IThirdPartyInstitutionRepository _thirdPartyIRepository; // Repository for accessing Bank data.
        private readonly ILogger<DeleteThirdPartyInstitutionommandHandler> _logger; // Logger for logging handler actions and errors.
        ...
        public DeleteThirdPartyInstitutionommandHandler(
            IThirdPartyInstitutionRepository thirdPartyIRepository, IMapper mapper,
            ILogger<DeleteThirdPartyInstitutionommandHandler> logger
, IUnitOfWork<POSContext> uow)
        ...
        public async Task<ServiceResponse<bool>> Handle(DeleteThirdPartyInstitutionCommand request, CancellationToken cancellationToken)
        {
