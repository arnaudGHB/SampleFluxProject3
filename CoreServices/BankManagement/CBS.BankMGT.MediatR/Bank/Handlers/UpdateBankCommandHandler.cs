...
namespace CBS.BankMGT.MediatR.Handlers
{
    ...
    /// </summary>
    public class UpdateBankCommandHandler : IRequestHandler<UpdateBankCommand, ServiceResponse<BankDto>>
    {
        private readonly IBankRepository _BankRepository; // Repository for accessing Bank data.
        private readonly ILogger<UpdateBankCommandHandler> _logger; // Logger for logging handler actions and errors.
        ...
        public async Task<ServiceResponse<BankDto>> Handle(UpdateBankCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                if (existingBank != null)
                {
                    ...
                    var response = ServiceResponse<BankDto>.ReturnResultWith200(_mapper.Map<BankDto>(existingBank));
                ...
                else
                {
                    ...
                    return ServiceResponse<BankDto>.Return404(errorMessage);
                }
            }
            catch (Exception e)
            {
