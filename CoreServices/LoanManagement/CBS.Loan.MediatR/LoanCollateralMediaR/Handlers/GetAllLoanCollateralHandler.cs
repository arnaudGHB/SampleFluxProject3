...
namespace CBS.NLoan.MediatR.LoanCollateralMediaR.Handlers
{
    ...
    /// </summary>
    public class GetAllLoanCollateralHandler : IRequestHandler<GetAllLoanCollateralQuery, ServiceResponse<List<LoanApplicationCollateralDto>>>
    {
        ...
        private readonly ILogger<GetAllLoanCollateralHandler> _logger; // Logger for logging handler actions and errors.

        /// <summary>
        /// Constructor for initializing the GetAllLoanCollateralQueryHandler.
        /// </summary>
        /// <param name="LoanCollateralRepository">Repository for LoanCollaterals data access.</param>
        /// <param name="mapper">AutoMapper for object mapping.</param>
        /// <param name="logger">Logger for logging handler actions and errors.</param>
        public GetAllLoanCollateralHandler(
            ILoanCollateralRepository LoanCollateralRepository,
            IMapper mapper, ILogger<GetAllLoanCollateralHandler> logger)
        {
        ...
        /// <summary>
        /// Handles the GetAllLoanCollateralQuery to retrieve all LoanCollaterals.
        /// </summary>
        /// <param name="request">The GetAllLoanCollateralQuery containing query parameters.</param>
        /// <param name="cancellationToken">A cancellation token.</param>
        public async Task<ServiceResponse<List<LoanApplicationCollateralDto>>> Handle(GetAllLoanCollateralQuery request, CancellationToken cancellationToken)
        {
            try
            {
                // Retrieve all LoanCollaterals entities from the repository
                var entities = await _LoanCollateralRepository.AllIncluding(x=>x.LoanProductCollateral, x=>x.LoanApplication).ToListAsync();
