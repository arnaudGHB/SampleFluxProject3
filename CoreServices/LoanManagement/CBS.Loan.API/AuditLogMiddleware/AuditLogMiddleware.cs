...
namespace CBS.NLoan.API
{
    ...
    public class AuditLogMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context, LoanContext dbContext)
        {
            try
            {
        ...
        private async Task LogAuditTrailAsync(HttpContext context, LoanContext dbContext)
        {
            try
            {
        ...
        private async Task LogErrorAuditTrailAsync(HttpContext context, LoanContext dbContext, Exception e)
        {
            var request = context.Request;
            request.RouteValues.TryGetValue(ControllerKey, out var controllerValue);
            var controllerName = (string)(controllerValue ?? string.Empty);
