...
namespace CBS.SystemConfiguration.API
{
    ...
    public class AuditLogMiddleware
    {
        ...
        private async Task LogAuditTrailAsync(HttpContext context, SystemContext dbContext)
        {
            try
            {
        ...
        private async Task LogErrorAuditTrailAsync(HttpContext context, SystemContext dbContext, Exception e)
        {
            var request = context.Request;
            request.RouteValues.TryGetValue(ControllerKey, out var controllerValue);
            var controllerName = (string)(controllerValue ?? string.Empty);
