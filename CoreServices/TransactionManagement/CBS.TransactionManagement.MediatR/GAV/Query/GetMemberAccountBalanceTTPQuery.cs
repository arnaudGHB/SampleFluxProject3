...
namespace CBS.TransactionManagement.MediatR.GAV.Query
{
    public class GetMemberAccountBalanceTTPQuery : IRequest<ServiceResponse<AccountBalanceThirdPartyDto>>
    {
        /// <summary>
