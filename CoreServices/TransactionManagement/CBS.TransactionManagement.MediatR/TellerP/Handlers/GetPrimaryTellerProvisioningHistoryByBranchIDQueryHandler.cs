...
namespace CBS.TransactionManagement.MediatR.TellerP.Handlers
{
    ...
    /// </summary>
    public class GetPrimaryTellerProvisioningHistoryByBranchIDQueryHandler : IRequestHandler<GetPrimaryTellerProvisioningHistoryByBranchIDQuery, ServiceResponse<List<PrimaryTellerProvisioningHistoryDto>>>
    {
        ...
        private readonly ILogger<GetPrimaryTellerProvisioningHistoryByBranchIDQueryHandler> _logger; // Logger for logging handler actions and errors.
        private readonly UserInfoToken _userInfoToken;

        /// <summary>
        /// Constructor for initializing the GetPrimaryTellerProvisioningHistoryByBranchIDQueryHandler.
        /// </summary>
        ...
        public GetPrimaryTellerProvisioningHistoryByBranchIDQueryHandler(
            IPrimaryTellerProvisioningHistoryRepository PrimaryTellerProvisioningHistoryRepository,
            UserInfoToken userInfoToken,
            IMapper mapper,
            ILogger<GetPrimaryTellerProvisioningHistoryByBranchIDQueryHandler> logger)
        {
        ...
        /// <summary>
        /// Handles the GetPrimaryTellerProvisioningHistoryByBranchIDQuery to retrieve a specific PrimaryTellerProvisioningHistory.
        /// </summary>
        /// <param name="request">The GetPrimaryTellerProvisioningHistoryByBranchIDQuery containing PrimaryTellerProvisioningHistory ID to be retrieved.</param>
        /// <param name="cancellationToken">A cancellation token.</param>
        public async Task<ServiceResponse<List<PrimaryTellerProvisioningHistoryDto>>> Handle(GetPrimaryTellerProvisioningHistoryByBranchIDQuery request, CancellationToken cancellationToken)
        {
            string errorMessage = null;
            try
            {
                // Retrieve the PrimaryTellerProvisioningHistory entity with the specified ID from the repository
                var entity = await _PrimaryTellerProvisioningHistoryRepository.FindBy(a => a.BranchId == request.BranchId).Include(x => x.Teller).Include(x => x.Teller.Transactions).ToListAsync();
                if (entity.Any())
                {
