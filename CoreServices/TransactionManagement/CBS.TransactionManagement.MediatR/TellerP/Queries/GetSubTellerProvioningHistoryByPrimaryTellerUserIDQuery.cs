...
namespace CBS.TransactionManagement.MediatR.TellerP.Queries
{
    ...
    /// </summary>
    public class GetSubTellerProvioningHistoryByPrimaryTellerUserIDQuery : IRequest<ServiceResponse<List<SubTellerProvioningHistoryDto>>>
    {
        /// <summary>
        /// Gets or sets the unique identifier of the SubTellerProvioningHistory to be retrieved.
        /// </summary>
        public string PrimaryTellerUSerID { get; set; }
    }
}
