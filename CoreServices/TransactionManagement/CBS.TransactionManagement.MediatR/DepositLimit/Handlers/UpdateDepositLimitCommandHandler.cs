...
namespace CBS.TransactionManagement.Handlers
{
    ...
    /// </summary>
    public class UpdateDepositLimitCommandHandler : IRequestHandler<UpdateDepositLimitCommand, ServiceResponse<CashDepositParameterDto>>
    {
        private readonly IDepositLimitRepository _DepositLimitRepository; // Repository for accessing DepositLimit data.
        private readonly ILogger<UpdateDepositLimitCommandHandler> _logger; // Logger for logging handler actions and errors.
        ...
        public UpdateDepositLimitCommandHandler(
            IDepositLimitRepository DepositLimitRepository,
            ILogger<UpdateDepositLimitCommandHandler> logger,
            IMapper mapper,
