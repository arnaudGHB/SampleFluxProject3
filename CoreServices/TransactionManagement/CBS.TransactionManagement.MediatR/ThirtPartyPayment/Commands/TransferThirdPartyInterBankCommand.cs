...
namespace CBS.TransactionManagement.MediatR.ThirtPartyPayment.Commands
{
    ...
    public class TransferThirdPartyInterBankCommand : IRequest<ServiceResponse<TransferThirdPartyDto>>
    {
        ...
        [Required(ErrorMessage = "Source Bank is required.")]
        [StringLength(100, ErrorMessage = "Source Bank can't be longer than 100 characters.")]
        public string SourceBank { get; set; }

        [Required(ErrorMessage = "Destination Bank is required.")]
        [StringLength(100, ErrorMessage = "Destination Bank can't be longer than 100 characters.")]
