...
{
    /// <summary>
    /// Represents a command to add a new OldLoanAccountingMaping.
    /// </summary>
    public class AddOldLoanAccountingMapingCommand : IRequest<ServiceResponse<OldLoanAccountingMapingDto>>
    {
