...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CBS.TransactionManagement.Data.Dto.FeeP.FeeDto", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CBS.TransactionManagement.Data.Dto.FeeP.FeePolicyDto", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CBS.TransactionManagement.Data.Entity.WithdrawalLimits.WithdrawalFeeDto", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("WithdrawalParameterId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("WithdrawalParameterId");

                    b.ToTable("WithdrawalFeeDto");
                });
            ...
            modelBuilder.Entity("CBS.TransactionManagement.Data.Dto.FeeP.FeePolicyDto", b =>
                {
                    b.HasOne("CBS.TransactionManagement.Data.Dto.FeeP.FeeDto", "Fee")
            ...
            modelBuilder.Entity("CBS.TransactionManagement.Data.Entity.WithdrawalLimits.WithdrawalFeeDto", b =>
                {
                    b.HasOne("CBS.TransactionManagement.Data.Dto.FeeP.FeePolicyDto", "FeePolicy")
                        .WithMany()
                        .HasForeignKey("FeePolicyID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CBS.TransactionManagement.Data.WithdrawalParameter", "WithdrawalParameter")
                        .WithMany("WithdrawalFees")
                        .HasForeignKey("WithdrawalParameterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FeePolicy");

                    b.Navigation("WithdrawalParameter");
                });
