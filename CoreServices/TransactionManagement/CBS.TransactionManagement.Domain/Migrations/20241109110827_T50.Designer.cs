...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CBS.TransactionManagement.Data.Entity.CashCeilingMovement.CashCeilingRequest", b =>
                {
                    ...
                    b.Property<decimal>("OperationDirection")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("CBS.TransactionManagement.Data.Entity.CashChangeHistoryDto", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CBS.TransactionManagement.Data.Entity.DailyStatisticBoard.GeneralDailyDashboard", b =>
                {
                    ...
                    b.Property<decimal>("PrimaryBalance")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("CBS.TransactionManagement.Data.Entity.SalaryFilesDto.SalaryExtractDto", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CBS.TransactionManagement.Data.Entity.SalaryFilesDto.SalaryExtractDto", b =>
                {
                    b.HasOne("CBS.TransactionManagement.Data.Entity.SalaryFiles.FileUpload", null)
                        .WithMany("SalaryExtracts")
                        .HasForeignKey("FileUploadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
