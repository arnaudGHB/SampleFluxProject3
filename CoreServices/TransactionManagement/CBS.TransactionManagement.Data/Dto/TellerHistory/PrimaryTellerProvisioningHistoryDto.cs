...
{
    public class PrimaryTellerProvisioningHistoryDto
    {
    ...
    public class TillOpenAndCloseOfDayDto
    {
        public string Id { get; set; }
        public string TellerId { get; set; }
        public string UserIdInChargeOfThisTeller { get; set; }
        ...
        public string InitialOpening { get; set; }
        // Calculated Properties for Closing Denominations
        public decimal ClosingTotal10000 => ClosingNote10000 * 10000;
        public decimal ClosingTotal5000 => ClosingNote5000 * 5000;
        public decimal ClosingTotal2000 => ClosingNote2000 * 2000;
        ...
        public bool IsClosingAmountValid()
        {
            // Calculate the total closing amount
            decimal totalClosingAmount = ClosingTotal10000 +
                                         ClosingTotal5000 +
                                         ClosingTotal2000 +
                                         ClosingTotal1000 +
                                         ClosingTotal500 +
                                         ...
                                         ClosingTotalCoin5 +
                                         ClosingTotalCoin1;
            var saasa = totalClosingAmount - CashAtHand;
            // Check if the total closing amount matches CashAtHand
            return totalClosingAmount == CashAtHand;
        }
    }
