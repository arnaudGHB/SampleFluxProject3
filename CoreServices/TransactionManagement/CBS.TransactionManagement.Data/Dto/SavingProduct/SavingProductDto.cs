...
namespace CBS.TransactionManagement.Dto
{
    public class SavingProductDto
    {
        ...
        public List<CashDepositParameterDto> CashDepositParameters { get; set; }
        public  List<ManagementFeeParameterDto> ManagementFeeParameters { get; set; }
        public  List<WithdrawalParameterDto> WithdrawalParameters { get; set; }
        public  List<EntryFeeParameterDto> EntryFeeParameters { get; set; }
        public  List<CloseFeeParameterDto> CloseFeeParameters { get; set; }
        public  List<ReopenFeeParameterDto> ReopenFeeParameters { get; set; }
        public  List<TermDepositParameterDto> TermDeposits { get; set; }
        public  List<TransferParameterDto> TransferParameters { get; set; }
