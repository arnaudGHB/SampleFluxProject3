...
namespace CBS.TransactionManagement.Data
{
    ...
    public class SubTellerProvioningHistory : BaseEntity
    {
        [Key]
        ...
        public decimal VolumeOfCashIn { get; set; }
        public decimal VolumeOfCashOut { get; set; }
        public decimal VolumeOfCashTransfered { get; set; }
        public decimal VolumeOfCashRecieved { get; set; }
