...
namespace CBS.AccountManagement.MediatR.Handlers
{
    ...
    /// </summary>
    public class UpdateCashMovementTrackingConfigurationCommandHandler : IRequestHandler<UpdateCashMovementTrackingConfigurationCommand, ServiceResponse<CashMovementTrackingConfigurationDto>>
    {
        ...
        private readonly ILogger<UpdateCashMovementTrackingConfigurationCommandHandler> _logger; // Logger for logging handler actions and errors.
        ...
        public UpdateCashMovementTrackingConfigurationCommandHandler(
            ICashMovementTrackingConfigurationRepository AccountPolicyNameRepository,
            ILogger<UpdateCashMovementTrackingConfigurationCommandHandler> logger,
        ...
        public async Task<ServiceResponse<CashMovementTrackingConfigurationDto>> Handle(UpdateCashMovementTrackingConfigurationCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                if (existingAccountPolicyName != null)
                {
                    ...
                    if (_userToken.IsHeadOffice && existingAccountPolicyName.CreatedBy!=_userToken.Id)
                    {
                        ...
                        var response = ServiceResponse<CashMovementTrackingConfigurationDto>.ReturnResultWith200(_mapper.Map<CashMovementTrackingConfigurationDto>(existingAccountPolicyName));
                    ...
                    else
                    {
                        ...
                        return ServiceResponse<CashMovementTrackingConfigurationDto>.Return401(errorMessage);
                    }
                ...
                else
                {
                    ...
                    _logger.LogError(errorMessage);
                    return ServiceResponse<CashMovementTrackingConfigurationDto>.Return404(errorMessage);
                }
            }
            catch (Exception e)
            {
