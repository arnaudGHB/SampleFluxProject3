...
namespace CBS.AccountManagement.MediatR.Handlers
{
    ...
    public class GetAccountByAccountNumberQueryHandler : IRequestHandler<GetAccountByAccountNumberQuery, ServiceResponse<AccountDto>>
    {
        ...
        private readonly ILogger<GetAccountByAccountNumberQueryHandler> _logger; // Logger for logging handler actions and errors.
        ...
        public GetAccountByAccountNumberQueryHandler(
            ...
            IMapper mapper,
            ILogger<GetAccountByAccountNumberQueryHandler> logger,UserInfoToken userInfoToken)
        {
        ...
        public async Task<ServiceResponse<AccountDto>> Handle(GetAccountByAccountNumberQuery request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var Account = _AccountRepository.FindBy(x=>x.AccountNumberCU.Equals(request.AccountNumber)).FirstOrDefault();
                if (Account != null)
                {
