...
namespace CBS.AccountManagement.MediatR.Handlers
{
    ...
    /// </summary>
    public class DeleteCashMovementTrackerCommandHandler : IRequestHandler<DeleteCashMovementTrackerCommand, ServiceResponse<bool>>
    {
        ...
        private readonly ILogger<DeleteCashMovementTrackerCommandHandler> _logger; // Logger for logging handler actions and errors.
        ...
        public DeleteCashMovementTrackerCommandHandler(
UserInfoToken userInfoToken,            ICashMovementTrackerRepository cashMovementTrackerRepository, IMapper mapper,
            ILogger<DeleteCashMovementTrackerCommandHandler> logger
, IUnitOfWork<POSContext> uow)
        ...
        public async Task<ServiceResponse<bool>> Handle(DeleteCashMovementTrackerCommand request, CancellationToken cancellationToken)
        {
