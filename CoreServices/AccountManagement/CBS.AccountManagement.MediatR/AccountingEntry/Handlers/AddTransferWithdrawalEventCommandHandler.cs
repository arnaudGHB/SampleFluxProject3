...
namespace CBS.AccountManagement.MediatR.Handlers
{
    ...
    public class AddTransferWithdrawalEventCommandHandler : IRequestHandler<AddTransferWithdrawalEventCommand, ServiceResponse<bool>>
    {
        ...
        private readonly ILogger<AddTransferWithdrawalEventCommandHandler> _logger;
        ...
        public AddTransferWithdrawalEventCommandHandler(
    ...
    IAccountingRuleEntryRepository accountingRuleEntryRepository,
            ...
            ILogger<AddTransferWithdrawalEventCommandHandler> logger,
        ...
        public async Task<ServiceResponse<bool>> Handle(AddTransferWithdrawalEventCommand command, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (transferComponent == null) 
                {
                    ...
                    return ServiceResponse<bool>.Return422("Transfer component not validated contact administrator");
                }
        ...
        private async Task<TransferComponent> GetTransferComponent(AddTransferWithdrawalEventCommand command)
        {
            try
            {
                ...
                if (command.TransferSource == "teller")
                {
                    ...
                    //transferComponent.Revenue.Account = await _accountingService.GetAccountBasedOnChartOfAccountID(entryRuleFromMemberRevenue.DeterminationAccountId);
