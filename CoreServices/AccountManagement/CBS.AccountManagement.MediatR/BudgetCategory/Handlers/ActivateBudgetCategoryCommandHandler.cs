...
namespace CBS.AccountManagement.MediatR.Handlers
{
    ...
    /// </summary>
    public class ActivateBudgetCategoryCommandHandler : IRequestHandler<ActivateBudgetCategoryCommand, ServiceResponse<BudgetCategoryDto>>
    {
        ...
        private readonly ILogger<ActivateBudgetCategoryCommandHandler> _logger; // Logger for logging handler actions and errors.
        ...
        public ActivateBudgetCategoryCommandHandler(
            IBudgetCategoryRepository BudgetCategoryNameRepository,
            IMapper mapper,
            ILogger<ActivateBudgetCategoryCommandHandler> logger,
        ...
        public async Task<ServiceResponse<BudgetCategoryDto>> Handle(ActivateBudgetCategoryCommand request, CancellationToken cancellationToken)
        {
            var errorMessage = "";
             try
            {
                ...
                if (existingBudgetCategory.Any())
                {
                    ...
                    //existingBudgetCategoryName.IsActive = true;
                    //existingBudgetCategoryName.ActivatedBy = _userInfoToken.Id;
                    ...
                    errorMessage = $"BudgetCategory {request.Id} was successfully Activated.";
                    ...
                    await APICallHelper.AuditLogger(_userInfoToken.Email, "ActivateBudgetCategoryCommand",
                ...
                else
                {
                    ...
                    errorMessage = $"BudgetCategory {request.Id} was not found to be Activated.";
