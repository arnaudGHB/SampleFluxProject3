...
namespace CBS.AccountManagement.MediatR.Handlers
{
    ...
    /// </summary>
    public class UnBlockBudgetCategoryCommandHandler : IRequestHandler<UnBlockBudgetCategoryCommand, ServiceResponse<BudgetCategoryDto>>
    {
        ...
        private readonly ILogger<UnBlockBudgetCategoryCommandHandler> _logger; // Logger for logging handler actions and errors.
        ...
        public UnBlockBudgetCategoryCommandHandler(
            IBudgetCategoryRepository BudgetCategoryNameRepository,
            IMapper mapper,
            ILogger<UnBlockBudgetCategoryCommandHandler> logger,
        ...
        public async Task<ServiceResponse<BudgetCategoryDto>> Handle(UnBlockBudgetCategoryCommand request, CancellationToken cancellationToken)
        {
            var errorMessage = "";
             try
            {
                ...
                if (existingBudgetCategory.Any())
                {
                    ...
                    //existingBudgetCategoryName.IsBlocked = false;
                    //existingBudgetCategoryName.BlockedBy = _userInfoToken.Id;
                    //existingBudgetCategoryName.BlockedDate= BaseUtilities.UtcToDoualaTime(DateTime.UtcNow);
                    ...
                    errorMessage = $"BudgetCategory {request.Id} was successfully Unblocked.";
                    ...
                    await APICallHelper.AuditLogger(_userInfoToken.Email, "UnBlockBudgetCategoryCommand",
                ...
                else
                {
                    ...
                    errorMessage = $"BudgetCategory {request.Id} was not found to be Unblocked.";
