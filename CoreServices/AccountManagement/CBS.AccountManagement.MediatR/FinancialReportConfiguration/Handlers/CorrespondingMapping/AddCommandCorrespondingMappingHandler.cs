...
namespace CBS.AccountManagement.MediatR.Handlers
{
    ...
    /// </summary>
    public class AddCommandCorrespondingMappingHandler : IRequestHandler<AddCommandCorrespondingMapping, ServiceResponse<bool>>
    {
        private readonly ICorrespondingMappingRepository _correspondingMappingRepository;
        private readonly ILogger<AddCommandCorrespondingMappingHandler> _logger; // Logger for logging handler actions and errors.
        ...
        public AddCommandCorrespondingMappingHandler(
            ICorrespondingMappingRepository documentReferenceCodeRepository,
            ILogger<AddCommandCorrespondingMappingHandler> logger,
            IMapper mapper,
        ...
        public async Task<ServiceResponse<bool>> Handle(AddCommandCorrespondingMapping request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                CorrespondingMapping referenceCode = _mapper.Map<CorrespondingMapping>(request);
