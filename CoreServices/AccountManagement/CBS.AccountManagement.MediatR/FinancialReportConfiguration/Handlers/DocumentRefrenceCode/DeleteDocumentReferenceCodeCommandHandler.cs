...
namespace CBS.AccountManagement.MediatR.Handlers
{
    ...
    /// </summary>
    public class DeleteCommandDocumentReferenceCodeHandler : IRequestHandler<DeleteCommandDocumentReferenceCode, ServiceResponse<bool>>
    {
        private readonly IDocumentReferenceCodeRepository _documentReferenceCodeRepository;
           private readonly ILogger<DeleteCommandDocumentReferenceCodeHandler> _logger; // Logger for logging handler actions and errors.
        ...
        public DeleteCommandDocumentReferenceCodeHandler(

            ILogger<DeleteCommandDocumentReferenceCodeHandler> logger,
            IMapper mapper,
        ...
        public async Task<ServiceResponse<bool>> Handle(DeleteCommandDocumentReferenceCode request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                return ServiceResponse<bool>.ReturnResultWith200(true, $"Reference code:{existingDocument.ReferenceCode} has been deleted successfully");
            }
            catch (Exception e)
            {
