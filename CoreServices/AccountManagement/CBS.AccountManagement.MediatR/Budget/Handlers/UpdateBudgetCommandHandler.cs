...
namespace CBS.AccountManagement.MediatR.Handlers
{
    ...
    /// </summary>
    public class UpdateBudgetCommandHandler : IRequestHandler<UpdateBudgetCommand, ServiceResponse<BudgetDto>>
    {
        private readonly IBudgetRepository _BudgetNameRepository; // Repository for accessing BudgetName data.
        private readonly ILogger<UpdateBudgetCommandHandler> _logger; // Logger for logging handler actions and errors.
        ...
        public async Task<ServiceResponse<BudgetDto>> Handle(UpdateBudgetCommand request, CancellationToken cancellationToken)
        {
