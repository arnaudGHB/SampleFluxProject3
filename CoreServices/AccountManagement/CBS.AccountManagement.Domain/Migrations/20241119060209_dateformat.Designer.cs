...
namespace CBS.AccountManagement.Domain.Migrations
{
    ...
    [Migration("20241119060209_dateformat")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CBS.AccountManagement.Data.ConditionalAccountReferenceFinancialReport", b =>
                {
                    ...
                    b.Property<string>("CountryReferenceCodeId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CountryReferenceCodeId");
            ...
            modelBuilder.Entity("CBS.AccountManagement.Data.Country", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CBS.AccountManagement.Data.CountryReferenceCode", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("CountryTypeId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("CountryReferenceCodes");
                });

            modelBuilder.Entity("CBS.AccountManagement.Data.CountryType", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CBS.AccountManagement.Data.StatementModel", b =>
                {
                    ...
                    b.Property<string>("Country_type")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CBS.AccountManagement.Data.ConditionalAccountReferenceFinancialReport", b =>
                {
                    b.HasOne("CBS.AccountManagement.Data.CountryReferenceCode", "CountryReferenceCode")
                        .WithMany("ConditionalAccountReferenceFinancialReport")
                        .HasForeignKey("CountryReferenceCodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CountryReferenceCode");
                });
            ...
            modelBuilder.Entity("CBS.AccountManagement.Data.CountryReferenceCode", b =>
                {
                    b.HasOne("CBS.AccountManagement.Data.ChartOfAccount", null)
                        .WithMany("CountryReferenceCodes")
                        .HasForeignKey("ChartOfAccountId");

                    b.HasOne("CBS.AccountManagement.Data.Country", "Country")
                        .WithMany("ReferenceCodes")
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CBS.AccountManagement.Data.CountryType", "CountryType")
                        .WithMany()
            ...
            modelBuilder.Entity("CBS.AccountManagement.Data.ChartOfAccount", b =>
                {
                    ...
                    b.Navigation("CountryReferenceCodes");
                });

            modelBuilder.Entity("CBS.AccountManagement.Data.Country", b =>
                {
                    b.Navigation("CountryTypes");
