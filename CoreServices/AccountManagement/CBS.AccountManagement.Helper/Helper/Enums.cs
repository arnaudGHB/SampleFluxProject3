namespace CBS.AccountManagement.Helper
{
    ...
    {
        /// <summary>
        /// Indicates that a new transaction log from the system.
        /// </summary>
        ...
        VaultInitilization,
        BranchToBranchTransferCashOut,
        CashRequisition,
        CleanAccountAndAccountingEntries,
        CashClearingTransferFromCashReplenishmentCommand,
        CashClearingTransferFromBankDepositCommand,
        ...
        Get6ColumnTrialBalanceQuery,
        Get4ColumnTrialBalanceQuery,
        GetAccountGLQuery,
        GetAccountingEntryByReferenceIdQuery,
        AddProductAccountingBookCommand,
        GetAccountStatusQuery,
        MakeLoanRefinancingCommand,
        LoanRefundPostingCommand,
        LoanDisbursementPostingCommand,
        LoanApprovalPostingCommand,
        InternalAutoPostingEventCommand,
        MakeNonCashAccountAdjustmentCommand,
        MakeBulkAccountPostingCommand,
        AddTransferEventCommand,
        AutoPostingEventCommand,
        AutomatedEventEntryCommand,
        AddCashReplenishmentApprovalCommand,
        AddBankCashOutTransactionCommand,
        AddTransferToNonMemberEventCommand,
        AddCashInfusionCommand,
        AddDepositApprovalCommand,
        AddDepositNotificationCommand,
        CheckIfReferenceIdExistQuery,
        GetAllCashReplenishmentPendingRequestQuery,
        GetAllCashReplenishmentQuery,
        GetAllDepositNotificationQueryAsBranch,
        ReverseAccountingEntryCommand,
        AddAccountingRuleCommand,
        UpdateAccountingEventRuleCommand,
        GetAccountingRuleQuery,
        GetAllAccountingRuleQuery,
        DeleteAccountingRuleCommand,
        AddEntryTempDataCommand,
        BulkPayement,
        GetAccountToAccountTransferByTransctionCode,
        AddTempDataEntriesCommand,
        ConfirmPostedEntriesCommand,
        AddEntryTempDataListCommand,
        BulkTransferCommand,
        BulkLoanRefundPostingCommand,
        BulkTransferCommand_InitializeAccounts,
        HttpRequestReception,
        GetJournalEntryQuery,
        APICallHelper,
        MakeRemittanceCommand,
        MakeRemittanceCommandCASHIN,
        MakeRemittanceCommandCASHOUT,
        NothingHappened
    }
    ...
    public enum LEVEL_OF_Execution
    {
   
        HEAD_OFFICE, BRANCH_OFFICE
