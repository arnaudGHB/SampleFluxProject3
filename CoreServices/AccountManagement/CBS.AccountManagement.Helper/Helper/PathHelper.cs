...
namespace CBS.AccountManagement.Helper
{
    public class PathHelper
    {
        ...
        public string UserInfoUrl
        {
            get
            {
                return _configuration["FileUploadServer:IdentityServerBaseUrl"]+ _configuration["UserInfo"];
            }
        }
        ...
        ///api/v1/AccountingDay/GetCurrentDay/{branchid}
        public string TransactionTrackerAccounting
        {
            get
            {
                return _configuration["Transactions:BaseUrl"] + _configuration["Transactions:Updating_TransactionTrackerAccounting"];
            }
        }
        public string GetAllTrackedTransactionAtAccounting
        {
            get
            {
                return _configuration["Transactions:BaseUrl"] + _configuration["Transactions:GetAll_TrackedTransactionAtAccounting"];
            }
        }
        ...
        public string LoadUserInfo
        {
            get
            {
                return _configuration["SystemAuthentication"];
            }
        }
        public string LoadQueryPrameter
        {
            get
            {
                return _configuration["TrackingQueryParameter"];
            }
        }
    
        public string CashInOrCashOutDenomination
        {
            get
            {
                return _configuration["Transactions:CashInOrCashOutDenomination"];
            }
        }
        public string EndOfDayActivity
        {
            get
            {
                return _configuration["EndOfDayActivity:AccountTracking"];
            }
        }
        public string GetAccountingDateUrl
        {
            get
            {
                return _configuration["Transactions:BaseUrl"] + _configuration["Transactions:AccountingDateUrl"];
            }
        }
        public string VaultTransferDenomination
        {
            get
            {
                return _configuration["Transactions:VaultTransferDenomination"];
            }
        }
        /// <summary>
        ...
        public AccountingOperations AccountingOperations
        {
            get
            {
                var model = JsonConvert.DeserializeObject<AccountingOperations>(  _configuration["AccountingOperations"]);
                return model;
            }
        }
        /// <summary>
        ...
        public string TransactionManagement_Savings
        {
            get
            {
                var model = _configuration["TransactionManagement:BaseUrl"] + _configuration["TransactionManagement:Savings"];
                return model;
            }
        }
        public string TransactionManagement_Loans
        {
            get
            {
                var model = _configuration["TransactionManagement:BaseUrl"] + _configuration["TransactionManagement:Loans"];
                return model;
            }
        }
        ...
        public string IdentityBaseUrl
        {
            get
            {
                return _configuration["FileUploadServer:IdentityServerBaseUrl"];
            }
        }
        public string LoginURL
        {
            get
            {
                return _configuration["LoginPath"];
            }
        }
    }
