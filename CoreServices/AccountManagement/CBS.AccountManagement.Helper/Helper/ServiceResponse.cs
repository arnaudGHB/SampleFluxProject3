...
namespace CBS.AccountManagement.Helper
{
    public class ServiceResponse<T>  
    {
        ...
        public static ServiceResponse<T> ReturnResultWith200(T data, string message= "Transaction was successful")
        {
            return new ServiceResponse<T>(200, data, "Transaction was successful",message,  "SUCCESS");
        }
