...
namespace CBS.AccountManagement.API.Model
{
    ...
    {
        public List<AccountDto> Upload(IFormFile file)
        {
            var ListOperationEvent = new List<AccountDto>();
            ...
            for (int i = 0; i < table.Rows.Count; i++)
            {
                if (i > 0)
                {
                    ...
                    ListOperationEvent.Add(new AccountDto { Id = col1, AccountName = col2/*, IBAN = col3 */});
                }
            }
