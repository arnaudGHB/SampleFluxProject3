...
using CBS.AccountManagement.MediatR.BackgroundServices;
using CBS.AccountManagement.MediatR.PipeLineBehavior;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "AccountManagement Micro Service API"
                });
        ...
        public void Configure(IApplicationBuilder app, ILoggerFactory loggerFactory, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint($"v1/swagger.json", "Accounting Management Services");
