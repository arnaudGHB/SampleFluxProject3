...
namespace CBS.AccountManagement.API
{
    ...
    public class RequestResponseLoggingMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            //await BaseUtilities.LogAndAuditAsync("Request response", new { ResponseBody = builder.ToString() }, HttpStatusCodeEnum.OK, LogAction.HttpRequestReception, LogLevelInfo.Information);
        ...
        private async Task<string> FormatRequest(HttpRequest request)
        {
            ...
            //await BaseUtilities.LogAndAuditAsync("Acknowledgement of request",new {Body=body,RequestUrl=   $"{request.Host}{request.Path} {request.QueryString}"}, HttpStatusCodeEnum.OK, LogAction.HttpRequestReception, LogLevelInfo.Information);
