...
namespace CBS.BudgetManagement.API
{
    ...
    public class AuditLogMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context, BudgetManagementContext dbContext)
        {
            try
            {
        ...
        private async Task LogAuditTrailAsync(HttpContext context, BudgetManagementContext dbContext)
        {
            try
            {
        ...
        private async Task LogErrorAuditTrailAsync(HttpContext context, BudgetManagementContext dbContext, Exception e)
        {
            var request = context.Request;
            request.RouteValues.TryGetValue(ControllerKey, out var controllerValue);
            var controllerName = (string)(controllerValue ?? string.Empty);
