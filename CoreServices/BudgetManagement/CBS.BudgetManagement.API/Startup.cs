using CBS.BudgetManagement.API.Helpers;
using CBS.BudgetManagement.Data;
using CBS.BudgetManagement.Domain;
using CBS.BudgetManagement.Helper;
using CBS.BudgetManagement.MediatR.PipeLineBehavior;
...
namespace CBS.BudgetManagement.API
{
    public class Startup
    {
        ...
        {
            var assembly = AppDomain.CurrentDomain.Load("CBS.BudgetManagement.MediatR");
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Budget Management Services"
                });
        ...
        public void Configure(IApplicationBuilder app, ILoggerFactory loggerFactory, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint($"v1/swagger.json", "Budget Management Services");
            ...
            try
            {
                ...
                {
                    var dbContext = scope.ServiceProvider.GetRequiredService<BudgetManagementContext>();
