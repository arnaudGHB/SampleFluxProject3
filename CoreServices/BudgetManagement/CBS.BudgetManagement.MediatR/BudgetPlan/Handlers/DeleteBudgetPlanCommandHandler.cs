...
namespace CBS.BudgetManagement.MediatR.Handlers
{
    ...
    /// </summary>
    public class DeleteBudgetPlanCommandHandler : IRequestHandler<DeleteBudgetPlanCommand, ServiceResponse<bool>>
    {
        private readonly IFiscalYearRepository _FiscalYearRepository; // Repository for accessing FiscalYear data.
        private readonly ILogger<DeleteBudgetPlanCommandHandler> _logger; // Logger for logging handler actions and errors.
        ...
        public DeleteBudgetPlanCommandHandler(
            IFiscalYearRepository FiscalYearRepository,
            ILogger<DeleteBudgetPlanCommandHandler> logger,
        ...
        public async Task<ServiceResponse<bool>> Handle(DeleteBudgetPlanCommand request, CancellationToken cancellationToken)
        {
