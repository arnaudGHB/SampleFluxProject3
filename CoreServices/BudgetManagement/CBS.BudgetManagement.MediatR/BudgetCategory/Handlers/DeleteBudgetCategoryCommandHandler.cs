...
{
    /// <summary>
    /// Handles the command to delete an BudgetCategory based on DeleteBudgetCategoryCommand.
    /// </summary>
    public class DeleteBudgetCategoryCommandHandler : IRequestHandler<DeleteBudgetCategoryCommand, ServiceResponse<bool>>
    {
        ...
        /// <summary>
        /// Constructor for initializing the DeleteBudgetCategoryCommandHandler.
        /// </summary>
        ...
        /// <summary>
        /// Handles the DeleteBudgetCategoryCommand to delete an BudgetCategory.
        /// </summary>
        /// <param name="request">The DeleteBudgetCategoryCommand containing the ID of the BudgetCategory to be deleted.</param>
        ...
        public async Task<ServiceResponse<bool>> Handle(DeleteBudgetCategoryCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                // Step 1: Check if the BudgetCategory entity with the specified Id exists
                ...
                // Step 2: Soft delete the BudgetCategory
                existingBudgetCategory.IsDeleted = true;
