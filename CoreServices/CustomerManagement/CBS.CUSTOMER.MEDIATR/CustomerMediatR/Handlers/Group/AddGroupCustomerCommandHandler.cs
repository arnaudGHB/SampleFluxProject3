...
namespace CBS.GroupCustomer.MEDIATR.GroupCustomerMediatR.Handlers
{
    ...
    /// </summary>
    public class AddGroupCustomerCommandHandler : IRequestHandler<AddGroupCustomerCommand, ServiceResponse<CreateGroupCustomer>>
    {
        ...
        public async Task<ServiceResponse<CreateGroupCustomer>> Handle(AddGroupCustomerCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    return ServiceResponse<CreateGroupCustomer>.Return404("Group Record with Id :  " + GroupId + " Does Not Exist");
                }

                if (request.CustomerIds == null && request.CustomerIds.Count <= 1)
                {
                    return ServiceResponse<CreateGroupCustomer>.Return404("Group Must Contain AtLeast 2 Customers");
                }
                ...
                {
                    // Map the AddGroupCustomerCommand to a GroupCustomer entity
                    var GroupCustomerEntity = new CUSTOMER.DATA.Entity.GroupCustomer()
                    {
                        CustomerGroupId = BaseUtilities.GenerateUniqueNumber(),
                ...
                {
                    return ServiceResponse<CreateGroupCustomer>.Return500();
                }

                var CreateGroupCustomer = _mapper.Map<CreateGroupCustomer>(GroupCustomersResult);
                return ServiceResponse<CreateGroupCustomer>.ReturnResultWith200(CreateGroupCustomer);
            }
            catch (Exception e)
            {
                ...
                return ServiceResponse<CreateGroupCustomer>.Return500(e);
            }
        }
    }
