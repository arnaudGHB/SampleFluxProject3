...
namespace CBS.CUSTOMER.HELPER.Helper
{
    ...
    public enum CMoneySubcriptionTypes
    {
        NewSubcription,
        SubcriptionRenewal,
        SubcriptionCancillation,
    }
    ...
    public enum LogAction
    {
        ...
        ResetPin,
        CMoneyResetPin,
        CMoneyMemberAccountActivation,
        CMoneyMemberActivation,
        CMoneyMemberUpdatePin,
        CMoneyMemberDeactivate,
        CMoneyMemberReactivation,
        CMoneyMemberPinReset,
        CMoneySecurityQuestionSET,
        CMoneyUpdateActivation,
        ChangePhoneNumber,
        GenerateTemporalOTP,
        GetCustomerAgeCategories,
        ErrorCustomerAgeCategory,
        CreateCustomerAgeCategory,
        MemberCreation,
        RetrieveMember,
        UpdateMemberAgeStatusOnMemberRetrival,
        RetrieveMemberByCustomerType,
    ...
    public enum FormalOrInformalSector
    {
       Formal_Private_Sector,
        Informal_Sector,
       Public_Sector
    }
    
    public enum BankingRelationship
    {
        Member,
        Non_Member
    } 
    ...
    {
        NextofkingsPhoto,
        NextofkingsSignature,
        CustomerPhoto,
        CustomerSignature,
        CustomerOtherDocument,
        GroupDocument,
        CardSignatureSpecimenDetailPhoto,
        CardSignatureSpecimenDetailSignature1,
        CardSignatureSpecimenDetailSignature2
    }
