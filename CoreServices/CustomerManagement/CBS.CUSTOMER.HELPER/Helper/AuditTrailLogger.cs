...
namespace CBS.CUSTOMER.HELPER.Helper
{
    public class AuditTrailLogger
    {
        ...
        public AuditTrailLogger(string action, string userName, string microService, string stringifyObject, string detailMessage, string level, int statusCode, string corolationid=null)
        {
            Action = action;
            UserName = userName;
