using CBS.FixedAssetsManagement.API.Helpers;
using CBS.FixedAssetsManagement.Data;
using CBS.FixedAssetsManagement.Domain;
using CBS.FixedAssetsManagement.Helper;
using CBS.FixedAssetsManagement.MediatR.PipeLineBehavior;
...
namespace CBS.FixedAssetsManagement.API
{
    public class Startup
    {
        ...
        {
            var assembly = AppDomain.CurrentDomain.Load("CBS.FixedAssetsManagement.MediatR");
            ...
            services.AddDbContext<FixedAssetsContext>(options =>
            {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Fixed Assets Management Services"
                });
        ...
        public void Configure(IApplicationBuilder app, ILoggerFactory loggerFactory, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint($"v1/swagger.json", "Fixed Assets Management Services");
            ...
            try
            {
                ...
                {
                    var dbContext = scope.ServiceProvider.GetRequiredService<FixedAssetsContext>();
