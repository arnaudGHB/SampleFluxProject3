...
namespace CBS.FixedAssetsManagement.API
{
    ...
    public class AuditLogMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context, FixedAssetsContext dbContext)
        {
            try
            {
        ...
        private async Task LogAuditTrailAsync(HttpContext context, FixedAssetsContext dbContext)
        {
            try
            {
        ...
        private async Task LogErrorAuditTrailAsync(HttpContext context, FixedAssetsContext dbContext, Exception e)
        {
            var request = context.Request;
            request.RouteValues.TryGetValue(ControllerKey, out var controllerValue);
            var controllerName = (string)(controllerValue ?? string.Empty);
