...
namespace CBS.DailyCollectionManagement.API
{
    ...
    public class AuditLogMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context, DailyCollectionContext dbContext)
        {
            try
            {
        ...
        private async Task LogAuditTrailAsync(HttpContext context, DailyCollectionContext dbContext)
        {
            try
            {
        ...
        private async Task LogErrorAuditTrailAsync(HttpContext context, DailyCollectionContext dbContext, Exception e)
        {
            var request = context.Request;
            request.RouteValues.TryGetValue(ControllerKey, out var controllerValue);
            var controllerName = (string)(controllerValue ?? string.Empty);
