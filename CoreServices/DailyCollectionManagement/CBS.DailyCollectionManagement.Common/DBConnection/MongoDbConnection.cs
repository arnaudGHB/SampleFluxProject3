...
namespace CBS.DailyCollectionManagement.Common.DBConnection
{
    public interface IMongoDb2Connection
    {
    ...
    public class MongoDbConnection : IMongoDbConnection, IDisposable, IMongoDb2Connection
    {
