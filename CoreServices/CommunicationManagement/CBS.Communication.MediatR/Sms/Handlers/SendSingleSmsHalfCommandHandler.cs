...
{
    public class SendSingleSmsHalfCommandHandler : IRequestHandler<SendSingleSmsHalfCommand, ServiceResponse<NotificationDto>>
    {
        ...
        public SendSingleSmsHalfCommandHandler(
            IMapper mapper,
        ...
        public async Task<ServiceResponse<NotificationDto>> Handle(SendSingleSmsHalfCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                notificationEntity.Title = "New Message";
                notificationEntity.CustomerName = "No Name";
