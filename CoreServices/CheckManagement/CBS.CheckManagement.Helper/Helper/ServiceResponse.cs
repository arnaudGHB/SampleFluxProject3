using CBS.CheckManagement.Helper.Model;
using System;
...
namespace CBS.CheckManagement.Helper
{
    public class ServiceResponse<T>
    {
        ...
        {
            return new ServiceResponse<T>(400, message, "Bad Request. Process terminated.", "FAILED");
        }
        public static ServiceResponse<T> Return400(T data)
        {
            return new ServiceResponse<T>(400, "Bad Request.", "Failed. Process terminated.", "FAILED");
        }
        
        public static ServiceResponse<T> Return400()
        {
            return new ServiceResponse<T>(400, "Bad Request.", "Failed. Process terminated.", "FAILED");
        }
        public static ServiceResponse<T> Return400(T data, string message)
        {
            return new ServiceResponse<T>(400, data, message, "Bad Request.", "FAILED");
        }
    }
