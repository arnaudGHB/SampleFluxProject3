...
namespace CBS.CheckManagement.API
{
    ...
    public class AuditLogMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context, TransactionContext dbContext)
        {
            try
            {
        ...
        private async Task LogAuditTrailAsync(HttpContext context, TransactionContext dbContext)
        {
            try
            {
        ...
        private async Task LogErrorAuditTrailAsync(HttpContext context, TransactionContext dbContext, Exception e)
        {
            var request = context.Request;
            request.RouteValues.TryGetValue(ControllerKey, out var controllerValue);
            var controllerName = (string)(controllerValue ?? string.Empty);
